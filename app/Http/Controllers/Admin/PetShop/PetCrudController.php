...
class PetCrudController extends CrudController
{
    ...
    protected function setupCreateOperation()
    {
        ...
        CRUD::field('owners')->subfields([['name' => 'role', 'type' => 'text']])->hint('<small class="float-right">Choose related Owners over a <code>belongsToMany</code> relationship, and edit "role" on the pivot table (n-n).</small>')->reorder('order');
